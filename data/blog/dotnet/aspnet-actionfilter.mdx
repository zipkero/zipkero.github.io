---
date: "2023-08-22"
title: ASP.NET Core Web ActionFilter
tags: ["dotnet", "asp.net"]
draft: false
...
> ASP.NET Core MVC 또는 WebAPI의 액션 메소드가 실행되기 전, 후 또는 액션 결과가 생성되거나 전송되기 전, 후에 추가적인 처리를 수행 할 수 있게 하는 요소입니다.
...
개입하여 코드의 재사용성을 높이고, 책임을 분리하기 위함입니다.
